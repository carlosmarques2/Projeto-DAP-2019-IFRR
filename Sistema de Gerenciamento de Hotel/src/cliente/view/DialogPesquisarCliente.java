 ...
 * @author carlos
 */
public class DialogPesquisarCliente extends javax.swing.JDialog {
    private ClienteDao clienteDao;
    /**
     * Creates new form DialogPesquisarCliente
     */
    public DialogPesquisarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisa de Clientes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.BELOW_TOP));
       ...
       jTFPesquisa.setText(jTFPesquisa.getText().toUpperCase());
        ...
        if (!dado.equals("")) {
            if (jCBPesquisa.getSelectedIndex() == 0) {
                populaTabelaCliente((ArrayList<ClienteBean>) clienteDao.pesquisarPorCodigo(new Integer(dado)));
            } else {
                populaTabelaCliente((ArrayList<ClienteBean>) clienteDao.pesquisarPorNome(dado));
            }
        } else {
            populaTabelaCliente((ArrayList<ClienteBean>) clienteDao.listar());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPesquisarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogPesquisarCliente dialog = new DialogPesquisarCliente(new javax.swing.JFrame(), true);
    ...
    private void cadastrarCliente() {
        FormCadCliente formCliente = new FormCadCliente();
        formCliente.setVisible(true);
    }

    private void alterarCliente() {
        ClienteBean clienteBean = pegaClienteSelecionado();
        if (clienteBean != null) {
            FormCadCliente formCadCliente = new FormCadCliente(clienteBean);
            formCadCliente.setVisible(true);
        }
    }

    private ClienteBean pegaClienteSelecionado() {
        if (verificarLinhaSelecionada()) {
            return (ClienteBean) (jTBPesquisa.getValueAt(jTBPesquisa.getSelectedRow(), -1));
        }
        return null;
    }
    
    private void populaTabelaCliente(ArrayList<ClienteBean> lista) {
        ClienteTableModel modeloCliente = new ClienteTableModel(lista);
        jTBPesquisa.setModel(modeloCliente);
    ...
    private void excluir() {
        if (verificarLinhaSelecionada()) {
            ...
            for (int i = 0; i < linhas.length; i++) {
                clienteBean = (ClienteBean) jTBPesquisa.getValueAt(linhas[i], -1);
                if (JOptionPane.showConfirmDialog(null, "Deseja realmente excluir o cliente " + clienteBean.getNome() + "?") == 0) {
                    if (excluirCliente(clienteBean)) {
                        JOptionPane.showMessageDialog(null, "Cliente " + clienteBean.getNome() + " excluído com sucesso!");
                    }
                }
            }
            carregaTabelaCliente();
    ...
    private boolean excluirCliente(ClienteBean clienteBean) {
        return clienteDao.excluir(clienteBean.getCodigo());
    }
    ...
    private void fecharTela() {
        if (JOptionPane.showConfirmDialog(null, "Deseja realmente fechar o Formulário de Pesquisa de Clientes?") == 0) {
            dispose();
        }
    }
